GRLIB_save_key = "SAIGA308_LIBERATION_SAVEGAME";	// change this value if you want different savegames on different map
...
GRLIB_sector_size = 250; // was 1000
