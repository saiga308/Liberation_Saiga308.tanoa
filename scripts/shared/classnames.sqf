...
infantry_units = [
	...
	["B_T_Sharpshooter_F",5,0,0],
	["B_T_HeavyGunner_F",5,0,0],
	["B_T_recon_F",4,0,0],
...
air_vehicles = [
	...
	["B_CTRG_Heli_Transport_03_tropic_F",0,20,15],
	["B_T_VTOL_01_armed_F",0,20,50],
	["B_T_VTOL_01_infantry_F",0,20,40],
	["B_T_VTOL_01_vehicle_F",0,20,40],
...
static_vehicles = [
	["B_T_HMG_01_F",0,10,0],
	["B_T_HMG_01_high_F",0,10,0],
	["B_T_GMG_01_F",0,20,0],
	["B_T_GMG_01_high_F",0,20,0],
	["B_T_static_AA_F",0,25,0],
	["B_T_static_AT_F",0,30,0],
...
if ( count blufor_squad_inf == 0 ) then { blufor_squad_inf = [ "B_T_Soldier_SL_F","B_T_Soldier_TL_F","B_T_soldier_AR_F","B_T_HeavyGunner_F","B_T_medic_F","B_T_Soldier_GL_F","B_T_Soldier_LAT_F","B_T_Soldier_LAT_F","B_T_soldier_M_F","B_T_Sharpshooter_F" ]; };
if ( isNil "blufor_squad_at" ) then { blufor_squad_at = [] };
if ( count blufor_squad_at == 0 ) then { blufor_squad_at = [ "B_T_Soldier_SL_F","B_T_soldier_AT_F","B_T_soldier_AT_F","B_T_soldier_AT_F","B_T_medic_F","B_T_Soldier_F" ]; };
if ( isNil "blufor_squad_aa" ) then { blufor_squad_aa = [] };
if ( count blufor_squad_aa == 0 ) then { blufor_squad_aa = [ "B_T_Soldier_SL_F","B_T_soldier_AA_F","B_T_soldier_AA_F","B_T_soldier_AA_F","B_T_medic_F","B_T_Soldier_F" ]; };
if ( isNil "blufor_squad_recon" ) then { blufor_squad_recon = [] };
if ( count blufor_squad_recon == 0 ) then { blufor_squad_recon = [ "B_T_recon_TL_F","B_T_recon_F","B_T_recon_exp_F","B_T_recon_medic_F","B_T_recon_LAT_F","B_T_recon_LAT_F","B_T_recon_M_F","B_T_Spotter_F","B_T_recon_F" ]; };
...
if ( isNil "blufor_squad_inf_light" ) then { blufor_squad_inf_light = [] };
if ( count blufor_squad_inf_light == 0 ) then { blufor_squad_inf_light = [ "B_T_Soldier_SL_F","B_T_Soldier_TL_F","B_T_Soldier_GL_F","B_T_soldier_AR_F","B_T_Soldier_GL_F","B_T_medic_F","B_T_Soldier_LAT_F","B_T_Soldier_F","B_T_Soldier_F"]; };
if ( isNil "uavs" ) then { uavs = [] }; uavs = [] + uavs + [ "B_UAV_01_F","B_UAV_02_F","B_T_UAV_03_F","B_T_UGV_01_F","B_T_UGV_01_rcws_F" ];
if ( isNil "elite_vehicles_extension" ) then { elite_vehicles_extension = [] }; elite_vehicles = [] + elite_vehicles_extension + ["B_T_UGV_01_rcws_F","B_T_MBT_01_TUSK_F","B_T_MBT_01_arty_F","B_T_MBT_01_mlrs_F","B_Heli_Attack_01_F","B_Plane_CAS_01_F","B_UAV_02_F","B_T_UAV_03_F"];
if ( isNil "ai_resupply_sources_extension" ) then { ai_resupply_sources_extension = [] };
ai_resupply_sources = [] + ai_resupply_sources_extension + [ Respawn_truck_typename, huron_typename, Arsenal_typename, "B_Slingload_01_Ammo_F", "B_T_APC_Tracked_01_CRV_F", "B_T_Truck_01_ammo_F", "JNS_Skycrane_Pod_Ammo_BLU_Black" ];
